...
<body>
    ...
    <div style="background: #f5f5f5; padding: 200px 20px; text-align: center; min-height: 100vh;">
        <h1 style="color: #333; margin-bottom: 20px;">🔐 请登录</h1>
        <form id="loginForm" style="max-width: 300px; margin: 0 auto; text-align: left;">
...
PROMPT;
    ...
    // AI分析API接口
    if (isset($_GET['api']) && $_GET['api'] === 'analyze_inventory') {
        header('Content-Type: application/json');
